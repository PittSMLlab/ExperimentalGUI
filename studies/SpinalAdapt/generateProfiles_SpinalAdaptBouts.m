...
%         stimR = stimL;
        ...
        velR = velL;
        stimSteps = [0 repmat(2,1,5), repmat([7 2 2 2 2 2],1,11)]; %build the intervals, 1st time a new stim intensity needs to be set, give a 6 stride break to turn the knobs
