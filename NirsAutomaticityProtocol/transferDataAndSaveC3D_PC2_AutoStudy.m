function transferDataAndSaveC3D_PC2_AutoStudy(participantID,visitNum, PCNum, studyName, indsTrials)
...
dirSrvrData = fullfile(['W:\Shuqi\' studyName '\Data'],participantID, visitNum);
dirSrvrRaw = fullfile(['W:\Shuqi\DataBackup\' studyName '\'],participantID,visitNum);   
